...
unsafe extern "C" fn init(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) {
    ...
    loop {
        ...
        match c {
            ...
            97 => {
                flags = 1 as libc::c_int | 2 as libc::c_int | 4 as libc::c_int | 8 as libc::c_int;
            }
            114 => {
...
unsafe extern "C" fn cc_dfs(mut g: *mut Agraph_t, mut n: *mut Agnode_t) {
    ...
    loop {
        ...
        e = agfstedge(g, n);
        while !e.is_null() {
            if n == (*(if ((*(e as *mut Agobj_t)).tag).objtype() as libc::c_int == 3 as libc::c_int
            {
                e
            } else {
...
unsafe extern "C" fn emit(mut g: *mut Agraph_t, mut root: libc::c_int, mut cl_count: libc::c_int) {
...
unsafe extern "C" fn eval(mut g: *mut Agraph_t, mut root: libc::c_int) -> libc::c_int {
    ...
    if flags & 8 as libc::c_int != 0 && root != 0 {
        agapply(
            ...
            Some(
                cntCluster
                    as unsafe extern "C" fn(*mut Agraph_t, *mut Agobj_t, *mut libc::c_void) -> (),
            ),
