...
#[no_mangle]
pub unsafe extern "C" fn nonconstraint_edge(mut e: *mut edge_t) -> libc::c_int {
...
unsafe extern "C" fn interclust1(
    mut g: *mut graph_t,
    mut t: *mut node_t,
    mut h: *mut node_t,
    mut e: *mut edge_t,
    ...
    let mut h_len: libc::c_int = 0;
    let mut t_rank: libc::c_int = 0;
    let mut h_rank: libc::c_int = 0;
    let mut rt: *mut edge_t = 0 as *mut edge_t;
    let mut rh: *mut edge_t = 0 as *mut edge_t;
        ...
        == 3 as libc::c_int
    {
        ...
        .is_null()
    {
        t_rank = (*((*((*(if ((*(e as *mut Agobj_t)).tag).objtype() as libc::c_int
            == 3 as libc::c_int
        {
            e
        } else {
                ...
                as libc::c_int == 3 as libc::c_int
            {
                ...
                .node as *mut Agobj_t))
                .data as *mut Agnodeinfo_t))
                .clust as *mut Agobj_t))
                .data as *mut Agraphinfo_t))
                .leader as *mut Agobj_t))
                .data as *mut Agnodeinfo_t))
                .rank;
    } else {
        t_rank = 0 as libc::c_int;
    }
    if !((*((*((*if ((*(e as *mut Agobj_t)).tag).objtype() as libc::c_int
        == 2 as libc::c_int
    {
        ...
        .is_null()
    {
        h_rank = (*((*((*(if ((*(e as *mut Agobj_t)).tag).objtype() as libc::c_int
            == 2 as libc::c_int
        {
            e
        } else {
        ...
        h_rank = 0 as libc::c_int;
    }
    offset = (*((*(e as *mut Agobj_t)).data as *mut Agedgeinfo_t)).minlen as libc::c_int
        + t_rank - h_rank;
    if offset > 0 as libc::c_int {
        t_len = 0 as libc::c_int;
        h_len = offset;
    } else {
        t_len = -offset;
        h_len = 0 as libc::c_int;
    }
    v = virtual_node(g);
    ...
    rt = make_aux_edge(
        v,
        t0,
        t_len as libc::c_double,
        10 as libc::c_int * (*((*(e as *mut Agobj_t)).data as *mut Agedgeinfo_t)).weight,
    );
    rh = make_aux_edge(
        v,
        h0,
        h_len as libc::c_double,
        (*((*(e as *mut Agobj_t)).data as *mut Agedgeinfo_t)).weight,
    );
    let ref mut fresh0 = (*((*(rh as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_orig;
    *fresh0 = e;
    let ref mut fresh1 = (*((*(rt as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_orig;
    *fresh1 = *fresh0;
}
#[no_mangle]
pub unsafe extern "C" fn class1(mut g: *mut graph_t) {
