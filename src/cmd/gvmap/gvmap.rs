    ...
    *fresh6 = 0 as libc::c_int as libc::c_double;
    ...
    loop {
        c = getopt(
            argc,
            argv,
            b":evODQko:m:s:r:p:c:C:l:b:g:t:a:h:z:d:?\0" as *const u8 as *const libc::c_char,
        );
        ...
        match c {
            ...
            104 => {
                ...
                {
                    (*pm).nedgep = if 0 as libc::c_int > v {
                        0 as libc::c_int
                    } else {
                        v
                    };
                ...
                {
                    (*pm).highlight_cluster = if 0 as libc::c_int > v {
                        0 as libc::c_int
                    } else {
                        v
                    };
            ...
            112 => {
                ...
                {
                    (*pm).show_points = if (3 as libc::c_int) < r {
                        3 as libc::c_int
                    } else {
                        r
                    };
            ...
            99 => {
                    ...
                    && strlen(stmp.as_mut_ptr()) == 2 as libc::c_int as libc::c_ulong
                {
                    ...
                    *fresh9 = stmp.as_mut_ptr();
                    ...
                    && r >= COLOR_SCHEME_NONE as libc::c_int
...
unsafe extern "C" fn makeMap(
    ...
    if (*pm).color_optimize as libc::c_int != 0
        && !country_graph.is_null()
        && !rgb_r.is_null()
        && !rgb_g.is_null()
        && !rgb_b.is_null()
    {
    ...
    plot_dot_map(
        ...
        rgb_b,
        (*pm).opacity,
        if (*pm).plotedges as libc::c_int != 0 {
            graph
        } else {
            0 as SparseMatrix
        },
...
unsafe extern "C" fn mapFromGraph(mut g: *mut Agraph_t, mut pm: *mut params_t) {
    ...
    makeMap(
        graph, n, x, width, grouping, labels, fsz, rgb_r, rgb_g, rgb_b, pm, g,
    );
}
