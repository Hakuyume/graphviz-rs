...
#[no_mangle]
pub unsafe extern "C" fn reverse_edge(mut e: *mut edge_t) {
...
unsafe extern "C" fn dfs(mut n: *mut node_t) {
...
#[no_mangle]
pub unsafe extern "C" fn acyclic(mut g: *mut graph_t) {
    ...
    while c
        < (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t))
            ...
            .size
    {
        let ref mut fresh0 = (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).nlist;
        *fresh0 = *((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t))
            .comp
            .list)
            .offset(c as isize);
