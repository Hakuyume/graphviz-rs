...
extern "C" {
    static mut gvrender_pango_types: [gvplugin_installed_t; 0];
    static mut gvtextlayout_pango_types: [gvplugin_installed_t; 0];
    static mut gvloadimage_pango_types: [gvplugin_installed_t; 0];
    static mut gvdevice_pango_types: [gvplugin_installed_t; 0];
}
...
static mut apis: [gvplugin_api_t; 5] = unsafe {
    [
        {
            let mut init = gvplugin_api_t {
                api: API_render,
                types: gvrender_pango_types.as_ptr() as *mut _,
            };
            init
        },
        {
            let mut init = gvplugin_api_t {
                api: API_textlayout,
                types: gvtextlayout_pango_types.as_ptr() as *mut _,
            };
            init
        },
        {
            let mut init = gvplugin_api_t {
                api: API_loadimage,
                types: gvloadimage_pango_types.as_ptr() as *mut _,
            };
            init
        },
        {
            let mut init = gvplugin_api_t {
                api: API_device,
                types: gvdevice_pango_types.as_ptr() as *mut _,
            };
            init
        },
        {
