...
extern "C" {
    ...
    fn gvRenderJobs(gvc: *mut GVC_t, g: *mut graph_t) -> libc::c_int;
    fn gvLayoutJobs(gvc: *mut GVC_t, g: *mut graph_t) -> libc::c_int;
    fn gvNEWcontext(
        builtins: *const lt_symlist_t,
        demand_loading: libc::c_int,
    ) -> *mut GVC_t;
    fn agattr(
        g: *mut Agraph_t,
        kind: libc::c_int,
    ...
    fn gvjobs_delete(gvc: *mut GVC_t);
    ...
    fn gvconfig_plugin_install_from_library(
        gvc: *mut GVC_t,
        package_path: *mut libc::c_char,
        library: *mut gvplugin_library_t,
    );
...
#[no_mangle]
pub unsafe extern "C" fn gvContext() -> *mut GVC_t {
    ...
    gvc = gvNEWcontext(0 as *const lt_symlist_t, (0 as libc::c_int == 0) as libc::c_int);
    gvconfig(gvc, 0 as libc::c_int != 0);
    return gvc;
}
#[no_mangle]
pub unsafe extern "C" fn gvContextPlugins(
    mut builtins: *const lt_symlist_t,
    mut demand_loading: libc::c_int,
) -> *mut GVC_t {
    let mut gvc: *mut GVC_t = 0 as *mut GVC_t;
    agattr(
        0 as *mut Agraph_t,
...
#[no_mangle]
pub unsafe extern "C" fn gvLayout(
    mut gvc: *mut GVC_t,
    mut g: *mut graph_t,
    ...
    if rc == 999 as libc::c_int {
        agerr(
            AGERR,
            b"Layout type: \"%s\" not recognized. Use one of:%s\n\0" as *const u8
    ...
    if gvLayoutJobs(gvc, g) == -(1 as libc::c_int) {
        return -(1 as libc::c_int);
    }
    if (*(*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).drawing).landscape {
        snprintf(
            ...
            if (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).bb.UR.y
                >= 0 as libc::c_int as libc::c_double
            {
            ...
            if (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).bb.UR.x
                >= 0 as libc::c_int as libc::c_double
            {
...
#[no_mangle]
pub unsafe extern "C" fn gvRender(
    mut gvc: *mut GVC_t,
    mut g: *mut graph_t,
    ...
    g = (*g).root;
    let mut r: bool = gvjobs_output_langname(gvc, format);
    job = (*gvc).job;
    if !r {
        agerr(
            AGERR,
            b"Format: \"%s\" not recognized. Use one of:%s\n\0" as *const u8
                as *const libc::c_char,
            format,
    ...
    if !(!(agbindrec(
        ...
        && (*job).flags & (1 as libc::c_int) << 26 as libc::c_int == 0
    {
        agerrorf(b"Layout was not done\n\0" as *const u8 as *const libc::c_char);
        return -(1 as libc::c_int);
    }
    let ref mut fresh0 = (*job).output_file;
    *fresh0 = out;
    if out.is_null() {
        (*job).flags |= (1 as libc::c_int) << 27 as libc::c_int;
    }
...
#[no_mangle]
pub unsafe extern "C" fn gvRenderFilename(
    mut gvc: *mut GVC_t,
    mut g: *mut graph_t,
    mut format: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn gvRenderContext(
    mut gvc: *mut GVC_t,
    mut g: *mut graph_t,
    mut format: *const libc::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn gvRenderData(
    mut gvc: *mut GVC_t,
    mut g: *mut graph_t,
    mut format: *const libc::c_char,
    mut result: *mut *mut libc::c_char,
    mut length: *mut libc::c_uint,
) -> libc::c_int {
    let mut rc: libc::c_int = 0;
    let mut job: *mut GVJ_t = 0 as *mut GVJ_t;
    g = (*g).root;
    ...
    if result.is_null()
        || {
            *result = malloc(4096 as libc::c_int as libc::c_ulong) as *mut libc::c_char;
            (*result).is_null()
        }
    {
        agerr(
            AGERR,
            b"failure malloc'ing for result string\0" as *const u8 as *const libc::c_char,
        );
        return -(1 as libc::c_int);
    }
    let ref mut fresh2 = (*job).output_data;
    *fresh2 = *result;
    (*job).output_data_allocated = 4096 as libc::c_int as libc::c_uint;
    (*job).output_data_position = 0 as libc::c_int as libc::c_uint;
    rc = gvRenderJobs(gvc, g);
    gvrender_end_job(job);
...
#[no_mangle]
pub unsafe extern "C" fn gvFreeRenderData(mut data: *mut libc::c_char) {
    free(data as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn gvAddLibrary(
    mut gvc: *mut GVC_t,
    mut lib: *mut gvplugin_library_t,
) {
    gvconfig_plugin_install_from_library(gvc, 0 as *mut libc::c_char, lib);
}
#[no_mangle]
pub unsafe extern "C" fn gvcInfo(mut gvc: *mut GVC_t) -> *mut *mut libc::c_char {
    return (*gvc).common.info;
}
#[no_mangle]
pub unsafe extern "C" fn gvcVersion(mut gvc: *mut GVC_t) -> *mut libc::c_char {
    return *((*gvc).common.info).offset(1 as libc::c_int as isize);
}
#[no_mangle]
pub unsafe extern "C" fn gvcBuildDate(mut gvc: *mut GVC_t) -> *mut libc::c_char {
    return *((*gvc).common.info).offset(2 as libc::c_int as isize);
}
