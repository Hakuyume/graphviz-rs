...
extern "C" {
    ...
    fn portcmp(p0: port, p1: port) -> libc::c_int;
    ...
    fn dot_scan_ranks(g: *mut graph_t);
...
unsafe extern "C" fn samedir(mut e: *mut edge_t, mut f: *mut edge_t) -> bool {
    let mut e0: *mut edge_t = 0 as *mut edge_t;
    let mut f0: *mut edge_t = 0 as *mut edge_t;
    e0 = e;
    while !e0.is_null()
        && (*((*(e0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).edge_type as libc::c_int
            != 0 as libc::c_int
    {
        e0 = (*((*(e0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_orig;
    }
    if e0.is_null() {
    ...
    f0 = f;
    while !f0.is_null()
        && (*((*(f0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).edge_type as libc::c_int
            != 0 as libc::c_int
    {
        f0 = (*((*(f0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_orig;
    }
    if f0.is_null() {
        return 0 as libc::c_int != 0;
    }
    if (*((*(e0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).conc_opp_flag {
        return 0 as libc::c_int != 0;
    }
    if (*((*(f0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).conc_opp_flag {
        return 0 as libc::c_int != 0;
    }
    return ((*((*((*(if ((*(f0 as *mut Agobj_t)).tag).objtype() as libc::c_int
        == 3 as libc::c_int
    {
        f0
    } else {
        f0.offset(1 as libc::c_int as isize)
    }))
        .node as *mut Agobj_t))
        .data as *mut Agnodeinfo_t))
        .rank
        - (*((*((*(if ((*(f0 as *mut Agobj_t)).tag).objtype() as libc::c_int
            == 2 as libc::c_int
        {
            f0
        } else {
...
unsafe extern "C" fn downcandidate(mut v: *mut node_t) -> bool {
    return (*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t)).node_type as libc::c_int
        ...
        && (*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t))
            ...
            .size
            == 1 as libc::c_int
        && ((*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t)).label).is_null();
}
unsafe extern "C" fn bothdowncandidates(mut u: *mut node_t, mut v: *mut node_t) -> bool {
    ...
    f = *((*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t))
        ...
        .list)
        .offset(0 as libc::c_int as isize);
    if downcandidate(v) as libc::c_int != 0
        ...
        .node
            ...
            .node
    {
        return samedir(e, f) as libc::c_int != 0
            && portcmp(
                (*((*(e as *mut Agobj_t)).data as *mut Agedgeinfo_t)).tail_port,
                (*((*(f as *mut Agobj_t)).data as *mut Agedgeinfo_t)).tail_port,
            ) == 0 as libc::c_int;
    }
    return 0 as libc::c_int != 0;
}
unsafe extern "C" fn upcandidate(mut v: *mut node_t) -> bool {
    return (*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t)).node_type as libc::c_int
        == 1 as libc::c_int
        && (*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t))
            .out
...
unsafe extern "C" fn bothupcandidates(mut u: *mut node_t, mut v: *mut node_t) -> bool {
    let mut e: *mut edge_t = 0 as *mut edge_t;
    let mut f: *mut edge_t = 0 as *mut edge_t;
    e = *((*((*(u as *mut Agobj_t)).data as *mut Agnodeinfo_t))
        .out
    ...
    f = *((*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t))
        ...
        .list)
        .offset(0 as libc::c_int as isize);
    if upcandidate(v) as libc::c_int != 0
            ...
            .node
    {
        return samedir(e, f) as libc::c_int != 0
            && portcmp(
                ...
                (*((*(f as *mut Agobj_t)).data as *mut Agedgeinfo_t)).head_port,
            ) == 0 as libc::c_int;
    }
    return 0 as libc::c_int != 0;
}
unsafe extern "C" fn mergevirtual(
    mut g: *mut graph_t,
    mut r: libc::c_int,
    mut lpos: libc::c_int,
    mut rpos: libc::c_int,
    ...
    let mut f: *mut edge_t = 0 as *mut edge_t;
    let mut e0: *mut edge_t = 0 as *mut edge_t;
    left = *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).v)
        .offset(lpos as isize);
    i = lpos + 1 as libc::c_int;
    while i <= rpos {
        right =
        ...
        if dir == 1 as libc::c_int {
            loop {
                e = *((*((*(right as *mut Agobj_t)).data as *mut Agnodeinfo_t))
                    .out
                    .list)
                    .offset(0 as libc::c_int as isize);
                if e.is_null() {
                ...
                k = 0 as libc::c_int;
                loop {
                    f = *((*((*(left as *mut Agobj_t)).data as *mut Agnodeinfo_t))
                        .out
                        .list)
                        .offset(k as isize);
                    if f.is_null() {
                ...
                loop {
                    e0 = *((*((*(right as *mut Agobj_t)).data as *mut Agnodeinfo_t))
                        .in_0
                        .list)
                        .offset(0 as libc::c_int as isize);
                    if e0.is_null() {
        ...
        if (*((*(right as *mut Agobj_t)).data as *mut Agnodeinfo_t))
            .in_0
            .size
            + (*((*(right as *mut Agobj_t)).data as *mut Agnodeinfo_t))
                .out
                .size
            == 0 as libc::c_int
        {
            ...
            __assert_fail(
                b"ND_in(right).size + ND_out(right).size == 0\0" as *const u8
                    as *const libc::c_char,
                b"conc.c\0" as *const u8 as *const libc::c_char,
                114 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 49], &[libc::c_char; 49]>(
                    b"void mergevirtual(graph_t *, int, int, int, int)\0",
                ))
                .as_ptr(),
            );
        }
    ...
    k = lpos + 1 as libc::c_int;
    i = rpos + 1 as libc::c_int;
    while i < (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).n {
        ...
        *fresh0 =
            *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).v)
                .offset(i as isize);
        n = *fresh0;
        (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).order = k;
        k += 1;
        i += 1;
    }
    (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).n = k;
    let ref mut fresh1 =
        *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).v)
            .offset(k as isize);
    *fresh1 = 0 as *mut node_t;
}
unsafe extern "C" fn infuse(mut g: *mut graph_t, mut n: *mut node_t) {
    let mut lead: *mut node_t = 0 as *mut node_t;
    lead = *((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rankleader)
        .offset((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).rank as isize);
    if lead.is_null()
        || (*((*(lead as *mut Agobj_t)).data as *mut Agnodeinfo_t)).order
            > (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).order
    {
        let ref mut fresh2 = *((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rankleader)
            .offset((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).rank as isize);
        *fresh2 = n;
    }
}
unsafe extern "C" fn rebuild_vlists(mut g: *mut graph_t) -> libc::c_int {
    ...
    while r <= (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).maxrank {
        let ref mut fresh3 =
            *((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rankleader).offset(r as isize);
    ...
    while !n.is_null() {
        infuse(g, n);
        let mut e: *mut edge_t = agfstout(g, n);
        while !e.is_null() {
            rep = e;
            while !((*((*(rep as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_virt).is_null() {
    ...
    while r <= (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).maxrank {
        ...
        if lead.is_null() {
            agerr(
                AGERR,
                b"rebuild_vlists: lead is null for rank %d\n\0" as *const u8 as *const libc::c_char,
                r,
            );
            return -(1 as libc::c_int);
        } else {
            if *((*((*((*(dot_root(g as *mut libc::c_void) as *mut Agobj_t)).data
                as *mut Agraphinfo_t))
                .rank)
                .offset(r as isize))
            .v)
                .offset((*((*(lead as *mut Agobj_t)).data as *mut Agnodeinfo_t)).order as isize)
                != lead
            {
                agerr(
                    AGERR,
                    b"rebuild_vlists: rank lead %s not in order %d of rank %d\n\0" as *const u8
                        as *const libc::c_char,
                    agnameof(lead as *mut libc::c_void),
                    (*((*(lead as *mut Agobj_t)).data as *mut Agnodeinfo_t)).order,
                    r,
                );
                return -(1 as libc::c_int);
        ...
        let ref mut fresh4 =
            (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).v;
        *fresh4 = ((*((*((*(dot_root(g as *mut libc::c_void) as *mut Agobj_t)).data
            as *mut Agraphinfo_t))
            .rank)
            .offset(r as isize))
        .v)
            ...
            < (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).n
        {
            ...
            if (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).node_type as libc::c_int
                == 0 as libc::c_int
            {
                if !(agcontains(g, n as *mut libc::c_void) != 0) {
                    break;
                }
                maxi = i;
            } else {
                let mut e_0: *mut edge_t = 0 as *mut edge_t;
                e_0 = *((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t))
                    .in_0
                    .list)
                    .offset(0 as libc::c_int as isize);
                while !e_0.is_null()
                    && !((*((*(e_0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_orig).is_null()
                {
                    e_0 = (*((*(e_0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_orig;
                }
                if !e_0.is_null()
                    && agcontains(
                        g,
                        (*(if ((*(e_0 as *mut Agobj_t)).tag).objtype() as libc::c_int
                            == 3 as libc::c_int
                        {
                            e_0
                        } else {
        ...
        if maxi == -(1 as libc::c_int) {
            agerr(
                AGWARN,
                b"degenerate concentrated rank %s,%d\n\0" as *const u8 as *const libc::c_char,
    ...
    while c <= (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).n_cluster {
        let mut ret: libc::c_int = rebuild_vlists(
...
#[no_mangle]
pub unsafe extern "C" fn dot_concentrate(mut g: *mut graph_t) {
    let mut c: libc::c_int = 0;
    let mut r: libc::c_int = 0;
    let mut leftpos: libc::c_int = 0;
    let mut rightpos: libc::c_int = 0;
    let mut left: *mut node_t = 0 as *mut node_t;
    let mut right: *mut node_t = 0 as *mut node_t;
    ...
    r = 1 as libc::c_int;
    while (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank)
        .offset((r + 1 as libc::c_int) as isize))
    .n != 0
    {
        leftpos = 0 as libc::c_int;
        while leftpos
            < (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).n
        {
            left = *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank)
                .offset(r as isize))
            .v)
                .offset(leftpos as isize);
            if downcandidate(left) {
                rightpos = leftpos + 1 as libc::c_int;
                while rightpos
                    < (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank)
                        .offset(r as isize))
                    .n
                {
                    right = *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank)
                        .offset(r as isize))
                    .v)
                        .offset(rightpos as isize);
                    if !bothdowncandidates(left, right) {
                        break;
                    }
                    rightpos += 1;
                }
                if rightpos - leftpos > 1 as libc::c_int {
                    mergevirtual(g, r, leftpos, rightpos - 1 as libc::c_int, 1 as libc::c_int);
                }
            }
            leftpos += 1;
        }
    ...
    while r > 0 as libc::c_int {
            ...
            < (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize)).n
        {
            ...
            if upcandidate(left) {
                ...
                if rightpos - leftpos > 1 as libc::c_int {
                    mergevirtual(g, r, leftpos, rightpos - 1 as libc::c_int, 0 as libc::c_int);
                }
            }
            leftpos += 1;
        }
    ...
    while c <= (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).n_cluster {
        ...
        ) != 0 as libc::c_int
        {
            agerr(
                AGPREV,
                b"concentrate=true may not work correctly.\n\0" as *const u8 as *const libc::c_char,
            );
            return;
        }
        c += 1;
