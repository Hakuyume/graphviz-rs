...
extern "C" {
    ...
    fn gvpr(argc: libc::c_int, argv: *mut *mut libc::c_char, opts: *mut gvpropts) -> libc::c_int;
}
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    let mut opts: gvpropts = gvpropts {
        ingraphs: 0 as *mut *mut Agraph_t,
        n_outgraphs: 0,
        outgraphs: 0 as *mut *mut Agraph_t,
        out: None,
        err: None,
        flags: 0,
        bindings: 0 as *mut gvprbinding,
    };
    opts.ingraphs = 0 as *mut *mut Agraph_t;
    opts.out = None;
    opts.err = None;
    opts.flags = 1 as libc::c_int;
    opts.bindings = 0 as *mut gvprbinding;
    graphviz_exit(gvpr(argc, argv, &mut opts));
}
pub fn main() {
