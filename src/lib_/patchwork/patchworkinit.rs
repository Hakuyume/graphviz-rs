...
extern "C" {
    ...
    fn patchworkLayout(g: *mut Agraph_t);
...
unsafe extern "C" fn mkClusters(
    ...
    if pclist.is_null() {
        ...
        if list.cnt != 0 {
            let ref mut fresh4 = (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).clust;
            *fresh4 = grealloc(
...
unsafe extern "C" fn patchwork_init_node(mut n: *mut node_t) {
    agset(
...
unsafe extern "C" fn patchwork_init_edge(mut e: *mut edge_t) {
    agbindrec(
...
unsafe extern "C" fn patchwork_init_node_edge(mut g: *mut graph_t) {
    let mut n: *mut node_t = 0 as *mut node_t;
    let mut e: *mut edge_t = 0 as *mut edge_t;
    let mut i: libc::c_int = 0 as libc::c_int;
    let mut alg: *mut rdata = gcalloc(
    ...
    *fresh5 = gcalloc(
    ...
    while !n.is_null() {
        ...
        *fresh6 = alg.offset(i as isize) as *mut libc::c_void;
        let fresh7 = i;
        i = i + 1;
...
unsafe extern "C" fn patchwork_init_graph(mut g: *mut graph_t) {
    N_shape = agattr(
        g,
        1 as libc::c_int,
        b"shape\0" as *const u8 as *const libc::c_char as *mut libc::c_char,
    ...
    let ref mut fresh9 = (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).ndim;
    *fresh9 = 2 as libc::c_int as libc::c_ushort;
    Ndim = *fresh9 as libc::c_int;
    mkClusters(g, 0 as *mut clist_t, g);
    patchwork_init_node_edge(g);
}
#[no_mangle]
pub unsafe extern "C" fn patchwork_layout(mut g: *mut Agraph_t) {
...
unsafe extern "C" fn patchwork_cleanup_graph(mut g: *mut graph_t) {
...
#[no_mangle]
pub unsafe extern "C" fn patchwork_cleanup(mut g: *mut graph_t) {
    let mut n: *mut node_t = 0 as *mut node_t;
    let mut e: *mut edge_t = 0 as *mut edge_t;
    n = agfstnode(g);
    if n.is_null() {
