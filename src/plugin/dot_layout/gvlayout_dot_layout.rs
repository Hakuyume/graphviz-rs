...
pub const LAYOUT_DOT: C2RustUnnamed_2 = 0;
#[no_mangle]
pub static mut dotgen_engine: gvlayout_engine_t = unsafe {
    {
        let mut init = gvlayout_engine_s {
            layout: Some(dot_layout as unsafe extern "C" fn(*mut graph_t) -> ()),
            cleanup: Some(dot_cleanup as unsafe extern "C" fn(*mut graph_t) -> ()),
        };
        init
    }
};
#[no_mangle]
pub static mut dotgen_features: gvlayout_features_t = {
...
#[no_mangle]
pub static mut gvlayout_dot_layout: [gvplugin_installed_t; 2] = unsafe {
    [
        {
            let mut init = gvplugin_installed_t {
                id: LAYOUT_DOT as libc::c_int,
                type_0: b"dot\0" as *const u8 as *const libc::c_char,
                quality: 0 as libc::c_int,
                engine: &dotgen_engine as *const gvlayout_engine_t as *mut gvlayout_engine_t
                    as *mut libc::c_void,
                features: &dotgen_features as *const gvlayout_features_t as *mut gvlayout_features_t
                    as *mut libc::c_void,
            };
            init
        },
