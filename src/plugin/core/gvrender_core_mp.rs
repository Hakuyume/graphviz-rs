...
pub const FORMAT_MP: C2RustUnnamed_4 = 0;
static mut Depth: libc::c_int = 0;
unsafe extern "C" fn mpptarray(
    mut job: *mut GVJ_t,
    mut A: *mut pointf,
    mut n: libc::c_int,
...
unsafe extern "C" fn mpColorResolve(
    ...
    let mut mindist: libc::c_long =
        (3 as libc::c_int * 255 as libc::c_int * 255 as libc::c_int) as libc::c_long;
    *new = 0 as libc::c_int;
    c = 0 as libc::c_int;
    while c < top {
...
static mut mpcolor: [*const libc::c_char; 8] = [
...
unsafe extern "C" fn mp_resolve_color(mut job: *mut GVJ_t, mut color: *mut gvcolor_t) {
    ...
    match (*color).type_0 as libc::c_uint {
        5 => {
            ...
            while i
                < (::std::mem::size_of::<[*const libc::c_char; 8]>() as libc::c_ulong)
                    ...
                    as libc::c_int
            {
                if strcmp(mpcolor[i as usize], (*color).u.string) == 0 {
                    (*color).u.index = i;
                    break;
                } else {
                    i += 1;
        ...
        0 => {
            (*color).u.index = 0 as libc::c_int;
        }
        _ => {
            __assert_fail(
                b"0\0" as *const u8 as *const libc::c_char,
                b"gvrender_core_mp.c\0" as *const u8 as *const libc::c_char,
                126 as libc::c_int as libc::c_uint,
                (*::std::mem::transmute::<&[u8; 44], &[libc::c_char; 44]>(
                    b"void mp_resolve_color(GVJ_t *, gvcolor_t *)\0",
                ))
                .as_ptr(),
            );
        }
...
unsafe extern "C" fn mp_line_style(
...
unsafe extern "C" fn mp_comment(mut job: *mut GVJ_t, mut str: *mut libc::c_char) {
    gvprintf(job, b"# %s\n\0" as *const u8 as *const libc::c_char, str);
}
unsafe extern "C" fn mp_begin_graph(mut job: *mut GVJ_t) {
...
unsafe extern "C" fn mp_end_graph(mut job: *mut GVJ_t) {
    gvputs(
        job,
        b"# end of FIG file\n\0" as *const u8 as *const libc::c_char,
    );
}
unsafe extern "C" fn mp_begin_page(mut job: *mut GVJ_t) {
    Depth = 2 as libc::c_int;
}
unsafe extern "C" fn mp_begin_node(mut job: *mut GVJ_t) {
    Depth = 1 as libc::c_int;
}
unsafe extern "C" fn mp_end_node(mut job: *mut GVJ_t) {
    Depth = 2 as libc::c_int;
}
unsafe extern "C" fn mp_begin_edge(mut job: *mut GVJ_t) {
    Depth = 0 as libc::c_int;
}
unsafe extern "C" fn mp_end_edge(mut job: *mut GVJ_t) {
    Depth = 2 as libc::c_int;
}
unsafe extern "C" fn mp_textspan(mut job: *mut GVJ_t, mut p: pointf, mut span: *mut textspan_t) {
    let mut obj: *mut obj_state_t = (*job).obj;
    ...
    let mut font_flags: libc::c_int = 4 as libc::c_int;
    let mut height: libc::c_double = 0.0f64;
    let mut length: libc::c_double = 0.0f64;
    if !((*(*span).font).postscript_alias).is_null() {
    ...
    gvprintf(
        job,
        b"%d %d %d %d %d %d %.1f %.4f %d %.1f %.1f %d %d\0" as *const u8 as *const libc::c_char,
        object_code,
        sub_type,
        color,
        depth,
...
unsafe extern "C" fn mp_ellipse(mut job: *mut GVJ_t, mut A: *mut pointf, mut filled: libc::c_int) {
    let mut obj: *mut obj_state_t = (*job).obj;
    ...
    mp_line_style(obj, &mut line_style, &mut style_val);
    center_x = if (*A.offset(0 as libc::c_int as isize)).x >= 0 as libc::c_int as libc::c_double {
        ((*A.offset(0 as libc::c_int as isize)).x + 0.5f64) as libc::c_int
    } else {
        ((*A.offset(0 as libc::c_int as isize)).x - 0.5f64) as libc::c_int
    };
    start_x = center_x;
    center_y = if (*A.offset(0 as libc::c_int as isize)).y >= 0 as libc::c_int as libc::c_double {
        ((*A.offset(0 as libc::c_int as isize)).y + 0.5f64) as libc::c_int
    } else {
        ((*A.offset(0 as libc::c_int as isize)).y - 0.5f64) as libc::c_int
    };
    ...
    end_x = if (*A.offset(1 as libc::c_int as isize)).x >= 0 as libc::c_int as libc::c_double {
        ((*A.offset(1 as libc::c_int as isize)).x + 0.5f64) as libc::c_int
    } else {
        ((*A.offset(1 as libc::c_int as isize)).x - 0.5f64) as libc::c_int
    };
    end_y = if (*A.offset(1 as libc::c_int as isize)).y >= 0 as libc::c_int as libc::c_double {
...
unsafe extern "C" fn mp_bezier(
    ...
    buffer = malloc(
        (((npoints + 1 as libc::c_int) * (6 as libc::c_int + 1 as libc::c_int) * 20 as libc::c_int)
            as libc::c_ulong)
...
unsafe extern "C" fn mp_polygon(
    ...
    mpptarray(job, A, n, 1 as libc::c_int);
}
unsafe extern "C" fn mp_polyline(mut job: *mut GVJ_t, mut A: *mut pointf, mut n: libc::c_int) {
    let mut obj: *mut obj_state_t = (*job).obj;
    let mut object_code: libc::c_int = 2 as libc::c_int;
    let mut sub_type: libc::c_int = 1 as libc::c_int;
    let mut line_style: libc::c_int = 0;
    ...
    mpptarray(job, A, n, 0 as libc::c_int);
}
#[no_mangle]
pub static mut mp_engine: gvrender_engine_t = unsafe {
    {
        let mut init = gvrender_engine_s {
            begin_job: None,
            end_job: None,
            begin_graph: Some(mp_begin_graph as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            end_graph: Some(mp_end_graph as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            begin_layer: None,
            end_layer: None,
            begin_page: Some(mp_begin_page as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            end_page: None,
            begin_cluster: None,
            end_cluster: None,
            begin_nodes: None,
            ...
            begin_edges: None,
            end_edges: None,
            begin_node: Some(mp_begin_node as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            end_node: Some(mp_end_node as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            begin_edge: Some(mp_begin_edge as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            end_edge: Some(mp_end_edge as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            begin_anchor: None,
            end_anchor: None,
            begin_label: None,
            end_label: None,
            textspan: Some(
                mp_textspan as unsafe extern "C" fn(*mut GVJ_t, pointf, *mut textspan_t) -> (),
            ),
            resolve_color: Some(
                mp_resolve_color as unsafe extern "C" fn(*mut GVJ_t, *mut gvcolor_t) -> (),
            ),
            ellipse: Some(
                mp_ellipse as unsafe extern "C" fn(*mut GVJ_t, *mut pointf, libc::c_int) -> (),
            ),
            polygon: Some(
                mp_polygon
            ...
            polyline: Some(
                mp_polyline as unsafe extern "C" fn(*mut GVJ_t, *mut pointf, libc::c_int) -> (),
            ),
            comment: Some(mp_comment as unsafe extern "C" fn(*mut GVJ_t, *mut libc::c_char) -> ()),
            library_shape: None,
        };
        init
    }
};
static mut render_features_mp: gvrender_features_t = {
...
static mut device_features_mp: gvdevice_features_t = {
...
#[no_mangle]
pub static mut gvrender_mp_types: [gvplugin_installed_t; 2] = unsafe {
    [
        {
            let mut init = gvplugin_installed_t {
                id: FORMAT_MP as libc::c_int,
                type_0: b"mp\0" as *const u8 as *const libc::c_char,
                quality: -(1 as libc::c_int),
                engine: &mp_engine as *const gvrender_engine_t as *mut gvrender_engine_t
                    as *mut libc::c_void,
                features: &render_features_mp as *const gvrender_features_t
...
#[no_mangle]
pub static mut gvdevice_mp_types: [gvplugin_installed_t; 2] = unsafe {
    [
        {
            let mut init = gvplugin_installed_t {
                id: FORMAT_MP as libc::c_int,
                type_0: b"mp:mp\0" as *const u8 as *const libc::c_char,
                quality: -(1 as libc::c_int),
                engine: 0 as *const libc::c_void as *mut libc::c_void,
                features: &device_features_mp as *const gvdevice_features_t
