...
#[no_mangle]
pub unsafe extern "C" fn dtmethod(mut dt: *mut Dt_t, mut meth: *mut Dtmethod_t) -> *mut Dtmethod_t {
    ...
    if ((*disc).eventf).is_some()
        && ((*disc).eventf).expect("non-null function pointer")(
            dt,
            4 as libc::c_int,
            meth as *mut libc::c_void,
            disc,
        ) < 0 as libc::c_int
    {
    ...
    list = dtflatten(dt);
    if (*(*dt).data).type_0 & (0o20 as libc::c_int | 0o40 as libc::c_int | 0o100 as libc::c_int)
        != 0
    {
    ...
    *fresh2 = 0 as *mut Dtlink_t;
    (*(*dt).data).type_0 =
        (*(*dt).data).type_0 & !(0o377 as libc::c_int | 0o10000 as libc::c_int) | (*meth).type_0;
    ...
    *fresh3 = meth;
    ...
    if (*meth).type_0 & (0o20 as libc::c_int | 0o40 as libc::c_int | 0o100 as libc::c_int) != 0 {
        if (*oldmeth).type_0 & (0o20 as libc::c_int | 0o40 as libc::c_int | 0o100 as libc::c_int)
            == 0
        {
            r = list;
            if !r.is_null() {
        ...
        *fresh7 = list;
        ...
        while !list.is_null() {
            r = (*list).right;
            ((*meth).searchf).expect("non-null function pointer")(
                dt,
        ...
        *fresh8 = 0 as libc::c_int;
        ...
        while !list.is_null() {
            ...
            if rehash != 0 {
                ...
                (*list).hl._hash = if ((*disc).hashf).is_some() {
