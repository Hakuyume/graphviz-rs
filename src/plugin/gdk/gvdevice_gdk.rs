...
extern "C" {
    ...
    fn gdk_pixbuf_save_to_callback(
...
pub type GdkColorspace = libc::c_uint;
pub const GDK_COLORSPACE_RGB: GdkColorspace = 0;
pub type GdkPixbuf = _GdkPixbuf;
pub type GdkPixbufDestroyNotify = Option<unsafe extern "C" fn(*mut guchar, gpointer) -> ()>;
pub type GdkPixbufSaveFunc =
    Option<unsafe extern "C" fn(*const gchar, gsize, *mut *mut GError, gpointer) -> gboolean>;
pub type C2RustUnnamed_4 = libc::c_uint;
pub const FORMAT_TIFF: C2RustUnnamed_4 = 4;
pub const FORMAT_PNG: C2RustUnnamed_4 = 3;
pub const FORMAT_JPEG: C2RustUnnamed_4 = 2;
pub const FORMAT_ICO: C2RustUnnamed_4 = 1;
pub const FORMAT_BMP: C2RustUnnamed_4 = 0;
unsafe extern "C" fn argb2rgba(
    ...
    while y < height {
        ...
        while x < width {
            let mut r: libc::c_char = *data.offset(2 as libc::c_int as isize);
            *data.offset(2 as libc::c_int as isize) = *data.offset(0 as libc::c_int as isize);
            *data.offset(0 as libc::c_int as isize) = r;
...
unsafe extern "C" fn writer(
    ...
    return (count == gvwrite(data as *mut GVJ_t, buf, count)) as libc::c_int;
}
unsafe extern "C" fn gdk_format(mut job: *mut GVJ_t) {
    let mut format_str: *mut libc::c_char =
        b"\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    let mut pixbuf: *mut GdkPixbuf = 0 as *mut GdkPixbuf;
    match (*job).device.id {
        0 => {
            format_str = b"bmp\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        1 => {
            format_str = b"ico\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        2 => {
            format_str = b"jpeg\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        3 => {
            format_str = b"png\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        4 => {
            format_str = b"tiff\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
        }
        _ => {
            fprintf(
                stderr,
                ...
                b"gvdevice_gdk.c\0" as *const u8 as *const libc::c_char,
                87 as libc::c_int,
            );
            abort();
        }
    ...
    if (*job).width
        ...
        && !(b"width out of range\0" as *const u8 as *const libc::c_char).is_null()
    {
    } else {
        __assert_fail(
            b"job->width <= (unsigned)INT_MAX / 4 && \"width out of range\"\0" as *const u8
                as *const libc::c_char,
            b"gvdevice_gdk.c\0" as *const u8 as *const libc::c_char,
            92 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 25], &[libc::c_char; 25]>(
                b"void gdk_format(GVJ_t *)\0",
            ))
            .as_ptr(),
        );
    }
    if (*job).height <= 2147483647 as libc::c_int as libc::c_uint
        && !(b"height out of range\0" as *const u8 as *const libc::c_char).is_null()
    {
    } else {
        __assert_fail(
            b"job->height <= (unsigned)INT_MAX && \"height out of range\"\0" as *const u8
                as *const libc::c_char,
            b"gvdevice_gdk.c\0" as *const u8 as *const libc::c_char,
    ...
    pixbuf = gdk_pixbuf_new_from_data(
        (*job).imagedata as *mut libc::c_uchar,
        GDK_COLORSPACE_RGB,
        (0 as libc::c_int == 0) as libc::c_int,
        8 as libc::c_int,
        (*job).width as libc::c_int,
        (*job).height as libc::c_int,
        4 as libc::c_int * (*job).width as libc::c_int,
        None,
...
static mut gdk_engine: gvdevice_engine_t = unsafe {
    {
        let mut init = gvdevice_engine_s {
            initialize: None,
            format: Some(gdk_format as unsafe extern "C" fn(*mut GVJ_t) -> ()),
            finalize: None,
        };
        init
    }
};
static mut device_features_gdk: gvdevice_features_t = {
...
#[no_mangle]
pub static mut gvdevice_gdk_types: [gvplugin_installed_t; 9] = unsafe {
    [
        {
            let mut init = gvplugin_installed_t {
                id: FORMAT_BMP as libc::c_int,
                type_0: b"bmp:cairo\0" as *const u8 as *const libc::c_char,
                quality: 6 as libc::c_int,
                engine: &gdk_engine as *const gvdevice_engine_t as *mut gvdevice_engine_t
                    as *mut libc::c_void,
                features: &device_features_gdk as *const gvdevice_features_t
        ...
        {
            let mut init = gvplugin_installed_t {
                id: FORMAT_ICO as libc::c_int,
                type_0: b"ico:cairo\0" as *const u8 as *const libc::c_char,
                quality: 6 as libc::c_int,
                engine: &gdk_engine as *const gvdevice_engine_t as *mut gvdevice_engine_t
                    as *mut libc::c_void,
                features: &device_features_gdk as *const gvdevice_features_t
        ...
        {
            let mut init = gvplugin_installed_t {
                id: FORMAT_TIFF as libc::c_int,
                type_0: b"tif:cairo\0" as *const u8 as *const libc::c_char,
                quality: 6 as libc::c_int,
                engine: &gdk_engine as *const gvdevice_engine_t as *mut gvdevice_engine_t
                    as *mut libc::c_void,
                features: &device_features_gdk as *const gvdevice_features_t
        ...
        },
        {
            let mut init = gvplugin_installed_t {
                id: FORMAT_TIFF as libc::c_int,
                type_0: b"tiff:cairo\0" as *const u8 as *const libc::c_char,
                quality: 6 as libc::c_int,
                engine: &gdk_engine as *const gvdevice_engine_t as *mut gvdevice_engine_t
                    as *mut libc::c_void,
                features: &device_features_gdk as *const gvdevice_features_t
