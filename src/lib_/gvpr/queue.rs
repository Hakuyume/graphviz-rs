...
static mut ndisc: Dtdisc_t = unsafe {
    {
        let mut init = _dtdisc_s {
            ...
            freef: ::std::mem::transmute::<
                Option::<
                    unsafe extern "C" fn(*mut Dt_t, *mut nsitem, *mut Dtdisc_t) -> (),
                >,
                Dtfree_f,
            >(
                Some(
...
pub unsafe extern "C" fn push(mut nq: *mut queue, mut n: *mut libc::c_void) {
    ...
    (Some(((*(nq as *mut Dt_t)).searchf).expect("non-null function pointer")))
        ...
        )(nq, &mut obj as *mut nsitem as *mut libc::c_void, 0o1 as libc::c_int);
}
#[no_mangle]
pub unsafe extern "C" fn pop(
    ...
    obj = (Some(((*(nq as *mut Dt_t)).searchf).expect("non-null function pointer")))
        .expect(
            "non-null function pointer",
        )(nq, 0 as *mut libc::c_void, 0o200 as libc::c_int) as *mut nsitem;
    if !obj.is_null() {
        n = (*obj).np;
        if delete != 0 {
            (Some(((*(nq as *mut Dt_t)).searchf).expect("non-null function pointer")))
                .expect(
                    "non-null function pointer",
                )(nq, 0 as *mut libc::c_void, 0o2 as libc::c_int);
        }
        return n;
    } else {
