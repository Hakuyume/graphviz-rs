...
extern "C" {
    ...
    fn gvNEWcontext(builtins: *const lt_symlist_t, demand_loading: libc::c_int) -> *mut GVC_t;
    fn agattr(
        g: *mut Agraph_t,
        kind: libc::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn gvAddLibrary(mut gvc: *mut GVC_t, mut lib: *mut gvplugin_library_t) {
