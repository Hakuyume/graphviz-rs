...
extern "C" {
    ...
    fn circularLayout(sg: *mut Agraph_t, rg: *mut Agraph_t);
...
unsafe extern "C" fn circular_init_edge(mut e: *mut edge_t) {
    agbindrec(
    ...
    (*((*(e as *mut Agobj_t)).data as *mut Agedgeinfo_t)).factor =
        late_double(e as *mut libc::c_void, E_weight, 1.0f64, 0.0f64);
}
unsafe extern "C" fn circular_init_node_edge(mut g: *mut graph_t) {
    let mut n: *mut node_t = 0 as *mut node_t;
    let mut e: *mut edge_t = 0 as *mut edge_t;
    let mut i: libc::c_int = 0 as libc::c_int;
    let mut alg: *mut ndata = gcalloc(
        agnnodes(g) as size_t,
        ::std::mem::size_of::<ndata>() as libc::c_ulong,
    ) as *mut ndata;
    let ref mut fresh0 = (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).neato_nlist;
    *fresh0 = gcalloc(
        (agnnodes(g) + 1 as libc::c_int) as size_t,
    ...
    while !n.is_null() {
        ...
        *fresh1 = alg.offset(i as isize) as *mut libc::c_void;
        let fresh2 = i;
        i = i + 1;
        let ref mut fresh3 = *((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).neato_nlist)
...
#[no_mangle]
pub unsafe extern "C" fn circo_init_graph(mut g: *mut graph_t) {
...
unsafe extern "C" fn makeDerivedNode(
    mut dg: *mut graph_t,
    mut name: *mut libc::c_char,
    mut isNode: libc::c_int,
    mut orig: *mut libc::c_void,
) -> *mut node_t {
    let mut n: *mut node_t = agnode(dg, name, 1 as libc::c_int);
    agbindrec(
    ...
    let ref mut fresh5 = (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).alg;
    *fresh5 =
        zmalloc(::std::mem::size_of::<cdata>() as libc::c_ulong) as *mut cdata as *mut libc::c_void;
    if isNode != 0 {
        let ref mut fresh6 = (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).pos;
        *fresh6 = gcalloc(
            Ndim as size_t,
            ::std::mem::size_of::<libc::c_double>() as libc::c_ulong,
        ) as *mut libc::c_double;
        (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).lw =
            (*((*(orig as *mut Agobj_t)).data as *mut Agnodeinfo_t)).lw;
        (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).rw =
            (*((*(orig as *mut Agobj_t)).data as *mut Agnodeinfo_t)).rw;
        (*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).ht =
            (*((*(orig as *mut Agobj_t)).data as *mut Agnodeinfo_t)).ht;
        let ref mut fresh7 = (*((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).alg
            as *mut cdata))
            .orig
            .np;
        *fresh7 = orig as *mut Agnode_t;
    } else {
        let ref mut fresh8 = (*((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).alg
            as *mut cdata))
            .orig
            .g;
        *fresh8 = orig as *mut Agraph_t;
    }
    return n;
}
unsafe extern "C" fn circomps(
    mut g: *mut Agraph_t,
    ...
    let mut dt: *mut Agnode_t = 0 as *mut Agnode_t;
    let mut dh: *mut Agnode_t = 0 as *mut Agnode_t;
    ...
    let ref mut fresh9 = (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).alg;
    *fresh9 = dg as *mut libc::c_void;
    v = agfstnode(g);
    while !v.is_null() {
        if ((*((*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t)).alg as *mut ndata)).dnode)
            .is_null()
        {
            n = makeDerivedNode(
                dg,
            ...
            let ref mut fresh10 =
                (*((*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t)).alg as *mut ndata)).dnode;
            *fresh10 = n;
        }
        v = agnxtnode(g, v);
    }
    ...
    while !v.is_null() {
        e = agfstout(g, v);
        while !e.is_null() {
            dt = (*((*((*((*if ((*(e as *mut Agobj_t)).tag).objtype() as libc::c_int
                == 3 as libc::c_int
            {
                e
            } else {
            ...
            .node as *mut Agobj_t))
                ...
                .alg as *mut ndata))
                .dnode;
            dh = (*((*((*((*if ((*(e as *mut Agobj_t)).tag).objtype() as libc::c_int
                == 2 as libc::c_int
            {
                e
            } else {
            ...
            if dt != dh {
                agbindrec(
                    agedge(dg, dt, dh, 0 as *mut libc::c_char, 1 as libc::c_int)
                        as *mut libc::c_void,
                    b"Agedgeinfo_t\0" as *const u8 as *const libc::c_char,
                    ::std::mem::size_of::<Agedgeinfo_t>() as libc::c_ulong as libc::c_uint,
                    1 as libc::c_int,
    ...
    ccs = ccomps(dg, &mut c_cnt, 0 as *mut libc::c_char);
    i = 0 as libc::c_int;
    while i < c_cnt {
        sg = *ccs.offset(i as isize);
        n = agfstnode(sg);
        while !n.is_null() {
            p = (*((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).alg as *mut cdata))
                .orig
                .np;
            e = agfstout(g, p);
            while !e.is_null() {
                ...
                .node as *mut Agobj_t))
                    ...
                    .dnode;
                if n != dh {
                    ep = agedge(dg, n, dh, 0 as *mut libc::c_char, 1 as libc::c_int);
                    agbindrec(
                    ...
                    agsubedge(sg, ep, 1 as libc::c_int);
                }
                e = agnxtout(g, e);
            }
            n = agnxtnode(sg, n);
    ...
    while !n.is_null() {
        e = agfstout(dg, n);
        while !e.is_null() {
            let ref mut fresh11 = (*((*(e as *mut Agobj_t)).data as *mut Agedgeinfo_t)).alg;
            *fresh11 = zmalloc(::std::mem::size_of::<edata>() as libc::c_ulong) as *mut edata
                as *mut libc::c_void;
            e = agnxtout(dg, e);
        }
        n = agnxtnode(dg, n);
...
unsafe extern "C" fn closeDerivedGraph(mut g: *mut graph_t) {
    let mut n: *mut node_t = 0 as *mut node_t;
    let mut e: *mut edge_t = 0 as *mut edge_t;
    n = agfstnode(g);
    while !n.is_null() {
        e = agfstout(g, n);
        while !e.is_null() {
            free((*((*(e as *mut Agobj_t)).data as *mut Agedgeinfo_t)).alg);
            e = agnxtout(g, e);
        }
...
unsafe extern "C" fn copyPosns(mut g: *mut graph_t) {
    let mut n: *mut node_t = 0 as *mut node_t;
    let mut v: *mut node_t = 0 as *mut node_t;
    n = agfstnode(g);
    while !n.is_null() {
        v = (*((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).alg as *mut cdata))
            .orig
            .np;
...
#[no_mangle]
pub unsafe extern "C" fn circoLayout(mut g: *mut Agraph_t) {
    let mut ccs: *mut *mut Agraph_t = 0 as *mut *mut Agraph_t;
    let mut sg: *mut Agraph_t = 0 as *mut Agraph_t;
    let mut ncc: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    if agnnodes(g) != 0 {
        ccs = circomps(g, &mut ncc);
        if ncc == 1 as libc::c_int {
            circularLayout(*ccs.offset(0 as libc::c_int as isize), g);
            copyPosns(*ccs.offset(0 as libc::c_int as isize));
            adjustNodes(g);
        } else {
            let mut dg: *mut Agraph_t = (**ccs.offset(0 as libc::c_int as isize)).root;
            ...
            packSubgraphs(ncc, ccs, dg, &mut pinfo);
            i = 0 as libc::c_int;
            while i < ncc {
                copyPosns(*ccs.offset(i as isize));
                i += 1;
            }
        }
...
#[no_mangle]
pub unsafe extern "C" fn circo_layout(mut g: *mut Agraph_t) {
...
#[no_mangle]
pub unsafe extern "C" fn circo_cleanup(mut g: *mut graph_t) {
    let mut n: *mut node_t = 0 as *mut node_t;
    let mut e: *mut edge_t = 0 as *mut edge_t;
    n = agfstnode(g);
    if n.is_null() {
    ...
    closeDerivedGraph((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).alg as *mut graph_t);
    while !n.is_null() {
        e = agfstout(g, n);
        while !e.is_null() {
            gv_cleanup_edge(e);
