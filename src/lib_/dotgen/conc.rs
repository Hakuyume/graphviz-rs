...
unsafe extern "C" fn samedir(mut e: *mut edge_t, mut f: *mut edge_t) -> bool {
    ...
    e0 = e;
    while !e0.is_null()
        && (*((*(e0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).edge_type
    ...
    f0 = f;
    while !f0.is_null()
        && (*((*(f0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).edge_type
            as libc::c_int != 0 as libc::c_int
    {
...
unsafe extern "C" fn bothdowncandidates(mut u: *mut node_t, mut v: *mut node_t) -> bool {
    ...
    e = *((*((*(u as *mut Agobj_t)).data as *mut Agnodeinfo_t)).in_0.list)
        .offset(0 as libc::c_int as isize);
    f = *((*((*(v as *mut Agobj_t)).data as *mut Agnodeinfo_t)).in_0.list)
        .offset(0 as libc::c_int as isize);
...
unsafe extern "C" fn mergevirtual(
    ...
    while i <= rpos {
        ...
        if dir == 1 as libc::c_int {
            loop {
                e = *((*((*(right as *mut Agobj_t)).data as *mut Agnodeinfo_t)).out.list)
                    .offset(0 as libc::c_int as isize);
                if e.is_null() {
                    break;
                }
        ...
        if (*((*(right as *mut Agobj_t)).data as *mut Agnodeinfo_t)).in_0.size
            + (*((*(right as *mut Agobj_t)).data as *mut Agnodeinfo_t)).out.size
            == 0 as libc::c_int
        {} else {
            __assert_fail(
            ...
            .n
    {
        ...
        let ref mut fresh0 = *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t))
            .rank)
            .offset(r as isize))
            .v)
            .offset(k as isize);
        *fresh0 = *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank)
            .offset(r as isize))
            .v)
            .offset(i as isize);
        n = *fresh0;
    ...
    (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank).offset(r as isize))
        .n = k;
    let ref mut fresh1 = *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank)
        .offset(r as isize))
        .v)
        .offset(k as isize);
...
unsafe extern "C" fn infuse(mut g: *mut graph_t, mut n: *mut node_t) {
    ...
    {
        let ref mut fresh2 = *((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t))
            .rankleader)
            .offset((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).rank as isize);
        *fresh2 = n;
    }
...
unsafe extern "C" fn rebuild_vlists(mut g: *mut graph_t) -> libc::c_int {
    ...
    while r <= (*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).maxrank {
        let ref mut fresh3 = *((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t))
            .rankleader)
            .offset(r as isize);
    ...
    while !n.is_null() {
        ...
        while !e.is_null() {
            rep = e;
            while !((*((*(rep as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_virt)
                .is_null()
            {
                        ...
                        .rank
            {
                ...
                rep = *((*((*((*if ((*(rep as *mut Agobj_t)).tag).objtype()
        ...
        *fresh4 = ((*((*((*(dot_root(g as *mut libc::c_void) as *mut Agobj_t)).data
                ...
                .n
        {
                ...
                as libc::c_int == 0 as libc::c_int
            {
                ...
                e_0 = *((*((*(n as *mut Agobj_t)).data as *mut Agnodeinfo_t)).in_0.list)
                    .offset(0 as libc::c_int as isize);
                while !e_0.is_null()
                    && !((*((*(e_0 as *mut Agobj_t)).data as *mut Agedgeinfo_t)).to_orig)
                        .is_null()
                {
                    e_0 = (*((*(e_0 as *mut Agobj_t)).data as *mut Agedgeinfo_t))
                        .to_orig;
                }
                if !e_0.is_null()
                    && agcontains(
            ...
            if downcandidate(left) {
                ...
                while rightpos
                    < (*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t)).rank)
                        ...
                        .n
                {
                    right = *((*((*((*(g as *mut Agobj_t)).data as *mut Agraphinfo_t))
                        .rank)
                        .offset(r as isize))
                        .v)
